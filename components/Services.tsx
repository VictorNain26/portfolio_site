  ...
  return (
    <Section className="scroll-mt-28 pb-28" id="services">
      <SectionHeading
        index="01"
        label="Services"
        lead="J'ajoute l'IA à une app qui tourne déjà, sans la réécrire. Je branche, je mesure ce que ça change. Si ça n'apporte rien, je le dis. Trois prestations IA, trois prestations web, le même code derrière."
