...
import { CAL_ORIGIN } from '@/lib/cal';
...
Cal("ui", { theme: "dark", layout: "month_view", hideEventTypeDetails: false, cssVarsPerTheme: { dark: { "cal-brand": "#6366f1" }, light: { "cal-brand": "#4f46e5" } } });`}
    </Script>
  );
}
